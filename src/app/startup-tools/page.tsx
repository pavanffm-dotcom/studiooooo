...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Rocket
} from 'lucide-react';
...
import { type Tool, type ToolCategory, startupToolData } from '@/lib/startup-tools-data';
...
export default function StartupToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return startupToolData;
        }
        return startupToolData.map(category => ({
            ...category,
