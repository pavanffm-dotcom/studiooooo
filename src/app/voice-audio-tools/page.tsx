...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Mic as MicIcon
} from 'lucide-react';
...
import { type Tool, type ToolCategory, voiceAudioToolData } from '@/lib/voice-audio-tools-data';


export default function VoiceAudioToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return voiceAudioToolData;
        }
        return voiceAudioToolData.map(category => ({
            ...category,
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <MicIcon className="w-6 h-6 text-foreground" />
