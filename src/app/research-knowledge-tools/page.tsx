...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, BrainCircuit
} from 'lucide-react';
...
import { type Tool, type ToolCategory, researchKnowledgeToolData } from '@/lib/research-knowledge-tools-data';

export default function ResearchKnowledgeToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return researchKnowledgeToolData;
        }
        return researchKnowledgeToolData.map(category => ({
            ...category,
