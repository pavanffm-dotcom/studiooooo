...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, File as FileIcon
} from 'lucide-react';
...
import { type Tool, type ToolCategory, pdfFileToolData } from '@/lib/pdf-file-tools-data';

export default function PdfFileToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return pdfFileToolData;
        }
        return pdfFileToolData.map(category => ({
            ...category,
