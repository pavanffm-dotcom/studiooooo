...
import {
    ArrowLeft, ExternalLink, Star, Share2, Filter, DollarSign
} from 'lucide-react';
...
import { type Tool, type ToolCategory, invoiceBillingToolData } from '@/lib/invoice-billing-tools-data';

export default function InvoiceBillingToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return invoiceBillingToolData;
        }
        return invoiceBillingToolData.map(category => ({
            ...category,
