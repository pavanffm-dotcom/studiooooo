...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, TrendingUp
} from 'lucide-react';
...
import { type Tool, type ToolCategory, seoAnalyticsToolData } from '@/lib/seo-analytics-tools-data';

export default function SeoAnalyticsToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return seoAnalyticsToolData;
        }
        return seoAnalyticsToolData.map(category => ({
            ...category,
