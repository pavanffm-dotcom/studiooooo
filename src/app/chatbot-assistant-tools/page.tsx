...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Bot as BotIcon
} from 'lucide-react';
...
import { type Tool, type ToolCategory, chatbotAssistantToolData } from '@/lib/chatbot-assistant-tools-data';


export default function ChatbotAssistantToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return chatbotAssistantToolData;
        }
        return chatbotAssistantToolData.map(category => ({
            ...category,
