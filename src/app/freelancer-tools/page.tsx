...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Briefcase
} from 'lucide-react';
...
import { type Tool, type ToolCategory, freelancerToolData } from '@/lib/freelancer-tools-data';
...
export default function FreelancerToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return freelancerToolData;
        }
        return freelancerToolData.map(category => ({
            ...category,
