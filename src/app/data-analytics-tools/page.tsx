...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, BarChart3
} from 'lucide-react';
...
import { type Tool, type ToolCategory, dataAnalyticsToolData } from '@/lib/data-analytics-tools-data';

export default function DataAnalyticsToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return dataAnalyticsToolData;
        }
        return dataAnalyticsToolData.map(category => ({
            ...category,
