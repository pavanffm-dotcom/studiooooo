...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Users as UsersIcon
} from 'lucide-react';
...
import { type Tool, type ToolCategory, socialMediaToolData } from '@/lib/social-media-tools-data';
...
export default function SocialMediaToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return socialMediaToolData;
        }
        return socialMediaToolData.map(category => ({
            ...category,
