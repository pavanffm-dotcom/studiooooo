...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Repeat
} from 'lucide-react';
...
import { type Tool, type ToolCategory, converterToolData } from '@/lib/converter-tools-data';
...
export default function ConverterToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return converterToolData;
        }
        return converterToolData.map(category => ({
            ...category,
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Repeat className="w-6 h-6 text-foreground" />
