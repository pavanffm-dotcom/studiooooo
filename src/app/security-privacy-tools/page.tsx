...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Shield
} from 'lucide-react';
...
import { type Tool, type ToolCategory, securityPrivacyToolData } from '@/lib/security-privacy-tools-data';

export default function SecurityPrivacyToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return securityPrivacyToolData;
        }
        return securityPrivacyToolData.map(category => ({
            ...category,
