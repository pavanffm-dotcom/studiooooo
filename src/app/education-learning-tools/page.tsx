...
import { type Tool, type ToolCategory, educationLearningToolData } from '@/lib/education-learning-tools-data';

export default function EducationLearningToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return educationLearningToolData;
        }
        return educationLearningToolData.map(category => ({
            ...category,
