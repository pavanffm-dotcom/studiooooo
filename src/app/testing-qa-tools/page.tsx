...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, TestTube
} from 'lucide-react';
...
import { type Tool, type ToolCategory, testingQAToolData } from '@/lib/testing-qa-tools-data';

export default function TestingQAToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return testingQAToolData;
        }
        return testingQAToolData.map(category => ({
            ...category,
