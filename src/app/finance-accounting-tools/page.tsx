...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Wallet
} from 'lucide-react';
...
import { type Tool, type ToolCategory, financeAccountingToolData } from '@/lib/finance-accounting-tools-data';

export default function FinanceAccountingToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return financeAccountingToolData;
        }
        return financeAccountingToolData.map(category => ({
            ...category,
