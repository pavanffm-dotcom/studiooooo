...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, ShoppingCart
} from 'lucide-react';
...
import { type Tool, type ToolCategory, eCommerceToolData } from '@/lib/ecommerce-tools-data';
...
export default function ECommerceToolsPage() {
    ...
    const filteredToolData = React.useMemo(() => {
        if (priceFilter === 'All') {
            return eCommerceToolData;
        }
        return eCommerceToolData.map(category => ({
            ...category,
