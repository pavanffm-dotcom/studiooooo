...
export const quickToolCategories: QuickToolCategory[] = [
    ...
    { name: 'AI Tools', image: 'https://picsum.photos/seed/ai-tools/600/400', dataAiHint: 'ai brain', url: '/ai-tools', translationKey: 'AiTools' },
    ...
    { name: 'UI/UX Design Tools', image: 'https://picsum.photos/seed/ui-ux-design/600/400', dataAiHint: 'user interface', url: '/ui-ux-design-tools', translationKey: 'UiUxDesignTools' },
